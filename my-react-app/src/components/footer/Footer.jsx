  ...
  return (
    <React.Fragment>
      <footer className={classes.footer}>
        <iframe style={{position:"fixed",bottom:"25px",right:"25px"}} id="chatWithMe" title="Chat with Me" width="600" height="600" src="https://nyskdwg8.chat.qbusiness.us-west-2.on.aws/"> </iframe>
